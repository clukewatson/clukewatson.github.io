function df = gradient_rclogit( argMU , argPSI )
%{
THETANL = thetaNL_init;
MUold = mu_init;
argMU = MU;
argPSI = psifunc( THETANL );
%}

global invA Z gmmresid P vi Xc yi; 
...
% *********************************************************************
% Use IFT to Calculate GMM Gradient
% *********************************************************************
